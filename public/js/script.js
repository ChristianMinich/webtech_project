...
function showResult() {
  ...
  if (userScore > 7) {
    let scoreTag =
      "<span>Du Genie! 🎉, Du hast <p>" +
      userScore +
      "</p> Fragen aus <p>" +
      questions.length +
      "</p> beantwortet !</span> <span>Ps. Brust raus !</span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore > 4) {
    let scoreTag =
      "<span>Nicht Schlecht! 😎, Du hast <p>" +
      userScore +
      "</p> Fragen aus <p>" +
      questions.length +
      "</p>beantwortet !</span> <span>Ps. kein Job bei Google aber irgendwo hier in der nähe schon :) </span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore > 1) {
    let scoreTag =
      "<span>Naja , Du hast <p>" +
      ...
      "</p> Fragen aus <p>" +
      questions.length +
      "</p>beantwortet !</span> <span>Ps. mit 80%iger Wahrscheinlischkeit bist du bei TI durchgefallen !</span>";
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag =
      "<span>Du Dummsack, Du hast nur <p>" +
      userScore +
      "</p> Frage aus <p>" +
      questions.length +
      "</p>beantwortet ! </span> <span>Ps. @Herr Ryba, Exmatrikulation bitte! </span>";
    scoreText.innerHTML = scoreTag;
  }
}
...
function startTimerLine(time) {
  ...
  function timer() {
    ...
    if (time > 549) {
      //if time value is greater than 549 Examp
      clearInterval(counterLine);
    }
  }
}
